...
$custom_characteristic1 = get_input('marketcharacteristic1');
$custom_characteristic2 = get_input('marketcharacteristic2');
...
$_SESSION['marketcharacteristic1'] = $custom_characteristic1;
$_SESSION['marketcharacteristic2'] = $custom_characteristic2;
...
if (empty($title) || empty($body)) {
	...
	$market->marketcharacteristic1 =$custom_characteristic1;
	$market->marketcharacteristic2 =$custom_characteristic2;
	
	// Before we can set metadata, we need to save the market post
	if (!$market->save()) {
		register_error(elgg_echo("market:error"));
		forward("mod/market/auto.php");	
	}
    ...
    remove_metadata($_SESSION['user']->guid,'marketcharacteristic1');
    remove_metadata($_SESSION['user']->guid,'marketcharacteristic2');
