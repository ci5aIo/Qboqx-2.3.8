...
Switch ($element){
	case 'new_story':
		...
		$expander     = elgg_view("output/url",  ['text'   => '','class'   => 'expander undraggable','id'      => 'toggle_marker','data-parent-cid'=>$parent_cid, 'data-cid'=>$cid,'tabindex'=> '-1',]);
		...
		$edit_details = elgg_view('output/div',['class'=>'story model item draggable feature unscheduled point_scale_linear estimate_-1 is_estimatable',
		                                       ...
		                                       . elgg_view($form,['section'=>'project_in_process', 'snippet'=>'marker', 'parent-cid'=>$parent_cid, 'cid'=>$cid])]);
		$story_model .= elgg_view('output/div', ['class'  =>'rTableRow',
		                                         'options'=> ['data-parent-cid'=>$parent_cid, 'data-cid'=>$cid],
	...
	case 'new_discovery':
		...
		$edit_details = elgg_view('output/div',['class'   => 'story model item draggable feature unscheduled point_scale_linear estimate_-1 is_estimatable',
		                    			    	...
		                    			    	'content' => $view_summary
		                                       . elgg_view($form,['section'=>'issue_discovery', 'action'=>'add', 'snippet'=>'marker', 'parent_cid'=>$parent_cid, 'cid'=>$cid, 'qid'=>$qid])]);
		$story_model .= elgg_view('output/div', ['class'  =>'rTableRow',
		                                         'options'=> ['data-parent-cid'=>$parent_cid, 'data-cid'=>$cid, 'data-qid'=>$qid],
		                                        'content'=>elgg_view('output/div', ['class'  =>'rTableCell',
		                                                                            'options'=>['style'=>'width:100%; padding: 0px 0px;vertical-align:top'],
