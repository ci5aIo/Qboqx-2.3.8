...
$experiences = elgg_get_entities_from_relationship(array(
	'type' => 'object',
	'relationship' => 'experience',
	'relationship_guid' => $item_guid,
	'inverse_relationship' => true,
...
//			    	'text' => elgg_view_icon('unlink', 'float-alt'),
	...
	echo '<tr>
	         ...
	         <td nowrap>'.
		      elgg_view('output/url', array(
				...
				'class' => 'elgg-lightbox elgg-button-submit-element',
			    'data-colorbox-opts' => '{"width":500, "height":325}',
				'href' => "jot/box/{$item_guid}/experience")).'
			 </td>
		  </tr>';
	echo '<tr><td colspan=2>';
	foreach ($experiences as $i) {
		...
		if($num_experiences > $limit){
			echo "<tr>
				      <td colspan=2>".elgg_view('output/url', array(
						'text' => 'more ...', 
					    'class' => 'elgg-lightbox elgg-button-submit-element',
					    'data-colorbox-opts' => '{"width":500, "height":525}',
		                'href' => "jot/show_more/experiences/$item_guid"))."</td>
			      </tr>";
		}	
	}
	if ($insights) {
