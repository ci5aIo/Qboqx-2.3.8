...
if (isset($vars['markettitle'])) {
	...
	//Add Fields
	$custom_characteristic1 = $vars('marketcharacteristic1');
	$custom_characteristic2 = $vars('marketcharacteristic2');
}
...
echo "<p></p><p><label>" . elgg_echo("market:custom1");
echo elgg_view("input/text", array(
				"name" => "marketcharacteristic1",
				"value" => $custom_characteristic1,
				));
			
echo "</label></p>";
echo "<p></p><p><label>" . elgg_echo("market:custom2");
echo elgg_view("input/text", array(
				"name" => "marketcharacteristic2",
				"value" => $custom_characteristic2,
				));
