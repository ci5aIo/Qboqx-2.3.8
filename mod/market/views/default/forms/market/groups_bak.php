<?php
/**
 * QuebX pick container form
 * Used in:
 	* jot\views\default\forms\jot\edit.php
 	* market\views\default\market\display\maintenance.php
 **/
...
//	echo elgg_dump($containers);
	foreach ($containers as $container) {
			...
			if (in_array($this_container_guid, $current_guids)){
				$input_radio    = "<input type='radio' name='selected_groups[]' checked='checked' value=$this_container_guid>";
				...
				$input_radio    = "<input type='radio' name='selected_groups[]' value=$this_container_guid>";
				$input_checkbox = elgg_view('input/checkbox', array(
									   'id'=>"group$this_container_guid", 
									   'value'=>$this_container_guid,
									   'name'=>'selected_groups[]',
