...
Hello World, this is my quebx index
</div>
CASE2;
//$sidebar = 'sidebar';
$nav = 'navigation';
...
$header = 'header';
$footer = 'footer';
$title = 'QuebX - A social network for stuff and the people who care for it';
$class = 'quebx-page';
//$pageshell = 'default';
$page_shell = 'public';
$something = 'something else';

$body_vars = array('something'=>$something);
...
$layout = elgg_view_layout('left_sidebar', array('head'=>$head, 'content' => $case2, 'sidebar'=>$sidebar, 'nav' => $nav, 'header'=>$header, 'footer'=>$footer, 'class'=>$class ));
...
echo elgg_view_page($title, $layout, $page_shell, $body_vars);