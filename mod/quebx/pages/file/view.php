...
$item = get_entity($file->container_guid);
if (!$file) {
...
if (elgg_instanceof($owner, NULL, 'market')) {
	elgg_push_breadcrumb($item->title, "market/view/$item->guid");
}

elgg_push_breadcrumb('\quebx\pages\file\view.php');
