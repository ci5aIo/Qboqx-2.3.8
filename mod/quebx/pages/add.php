...
if ($parent_guid){
	  elgg_push_breadcrumb($parent_item->title, "quebx/view/".$parent_guid);
} else {
	  elgg_push_breadcrumb('no parent');
}
elgg_push_breadcrumb($title, "quebx/view/".$guid);
...
$content = elgg_view_form("add/items".$h, $form_vars, $body_vars);
