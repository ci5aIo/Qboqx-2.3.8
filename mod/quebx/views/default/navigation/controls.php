...
$delete_action= elgg_extract('delete_action', $buttons, 'delete');
...
if ($buttons){
    if ($buttons['delete'] && $delete_action == 'replace'){
         $delete_class = 'trashEnvelope_0HziOPGx';
         $delete_title = 'Replace this boqx'.$disabled_label;
    }
    if ($buttons['delete'] && $delete_action == 'disable'){
         $delete_class = 'disableItem_WCeQcYKQ';
         $delete_title = 'Move to trash'.$disabled_label;
    }
}
...
//    case 'pack carton':
    ...
    case 'pack carton': $submit_class[]='packCarton_GAz9q0NX';    break;
    default: break;
}
