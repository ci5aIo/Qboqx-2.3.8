					...
					<ul class='item settings_area'>
						<li class='ProjectSidebar__header___30T22TC6'>
							<div class='ProjectSidebar__teamStatus___17YjbEgP'>
								...
								<a href='https://www.pivotaltracker.com/n/projects/2068141/memberships' class='members ProjectSidebar__teamMembers___1ZtT31rT' data-aid='ProjectSidebar__MembershipLink' title='1 project members'>
									<span>1</span>
								</a>
							</div>
			...
			<footer class='sidebar_footer'>
				<div class='disabled'>
					...
					<form id='form_layout' class='SidebarFooter__sliderContainer___1YVq_U7c'>
						...
						<input name='layout[panel_width]' type='range' aria-label='Set panel width' class='SidebarFooter__slider___3e6IcZxR' min='375' max='1000' data-type='number' disabled='' value='375'>
