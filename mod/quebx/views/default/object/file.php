...
/**
 * File renderer.
 * Extended from File plugin
 * @TODO Determine why must edit mod\file\start.php to extend.  
 * @package ElggFile
 */
...
if ($full && !elgg_in_context('gallery')) {
	...
	$body = "$text $extra";
	if ($items) {
		$body .= '<br><b>Related items</b><br>
		          <ul style="list-style:square inside">';
	foreach ($items as $i) {
			$body .= '<li>'.elgg_view('output/url', array('text' => $i->title,'href' =>  'market/view/'.$i->guid)).'</li>';
		}
     $body .= '</ul>';
	}	

	echo 'View: \quebx\views\default\object\file.php<br>';
