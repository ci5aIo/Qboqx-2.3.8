<?php
/**
 * Layout for multiple panels with one sidebar
 *
 * @package Elgg
 * @subpackage Core
 *
...
$class = 'quebx-layout quebx-layout-panels clearfix';
if (isset($vars['class'])) {
...
<div class="<?php echo $class; ?>">
	...
	<div class="elgg-main elgg-body">
		<!--Layout: mod\quebx\views\default\page\layouts\left_sidebar.php-->
		<?php
