<!-- mod/quebx/views/default/page/components/gallery.php -->
<?php
...
//@EDIT - 2020-05-20 - SAJ - Added capacity to receive multiple item_classes as an array
$item_classes = ['elgg-item'];
if (isset($vars['item_class'])) {
    if(is_array($vars['item_class']))
         $item_classes   = array_merge($item_classes, $vars['item_class']);
    else $item_classes[] = $vars['item_class'];
}
