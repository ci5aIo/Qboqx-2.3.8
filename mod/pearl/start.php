...
$url = elgg_get_site_url();
    if (elgg_get_context() != 'admin') {
        ...
        elgg_register_css('modules', $url . 'mod/pearl/css/modules.css');
...
*/
     $pearl_js     = elgg_get_simplecache_url('js' , 'pearl');
     //elgg_register_js('pearl_js',$pearl_js,'head',5);
     //elgg_load_js('pearl_js');
     elgg_require_js($pearl_js);
