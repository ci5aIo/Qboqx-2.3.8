...
<div id="wrapper">
    ...
    <div class="slider-wrapper theme-default">
        <div id="slider" class="nivoSlider">
            <img src="<?php echo $url; ?>mod/pearl/graphics/slide1.jpg" alt="" />
            <img src="<?php echo $url; ?>mod/pearl/graphics/slide2.jpg" alt="" />
            <img src="<?php echo $url; ?>mod/pearl/graphics/slide3.jpg" alt="" />
        </div>
    </div>
