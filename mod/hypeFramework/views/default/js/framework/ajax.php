...
<?php endif; ?>
	...
	*/
	...
	framework.ajax.init = function() {
		...
		.on('click', framework.ajax.getUpdatedList);

		$('.hj-framework-list-filter form')
		.on('submit', framework.ajax.filterList);
		...
		.on('click', framework.ajax.scenarios.createEntity);

		$('.elgg-button-edit-entity')
		.on('click', framework.ajax.scenarios.editEntity);

		$('.elgg-button-delete-entity')
		.on('click', framework.ajax.scenarios.deleteEntity);
