...
elgg_extend_view('page/elements/head', 'landr/js');  
...
<div class="landr-slider">
    ...
    <?php if ($welcome_message) { echo $welcome_message; } else { ?>
        <h1>Welcome to <?php echo elgg_get_config('sitename', 0); ?></h1> 
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. asdf asdf</p>
    <?php } ?>
...
<div class="landr-section row1">
    <div class="landr-container">
        <div class="landr-columns"> 
            ...
            <h2><?php if ($intro_heading_1) { echo $intro_heading_1; } else { echo 'Responsive'; } ?></h2>
            <?php if ($intro_heading_text1) { echo $intro_heading_text1; } else { echo '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis lobortis massa, et convallis massa malesuada at. Morbi semper convallis augue sed congue.</p>'; } ?>
        </div>
        <div class="landr-columns">
            <i class="fa fa-<?php if ($fa1) { echo $fa1; } else { echo 'cube'; } ?>"></i>
            <h2><?php if ($intro_heading_2) { echo $intro_heading_2; } else { echo 'Flat UI'; } ?></h2>
            <?php if ($intro_heading_text2) { echo $intro_heading_text2; } else { echo '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis lobortis massa, et convallis massa malesuada at. Morbi semper convallis augue sed congue.</p>'; } ?>
        </div>
        <div class="landr-columns">
            <i class="fa fa-<?php if ($fa1) { echo $fa1; } else { echo 'code'; } ?>"></i> 
            <h2><?php if ($intro_heading_3) { echo $intro_heading_3; } else { echo 'Easy Customizations'; } ?></h2>
            <?php if ($intro_heading_text3) { echo $intro_heading_text3; } else { echo '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis lobortis massa, et convallis massa malesuada at. Morbi semper convallis augue sed congue.</p>'; } ?>
        </div>
    </div>
</div>

<div class="landr-section row2">
    <h1><?php if ($member_heading) { echo $member_heading; } else { echo 'MEET OUR RECENT MEMBERS'; } ?></h1>
    <div class="landr-container"> 
        <?php 
