...
elgg_entity_gatekeeper($folder_guid, "object", item_tools_SUBTYPE);
...
// build page elements
$title_text = elgg_echo("item_tools:edit:title");
$title = elgg_view_title($title_text);

$edit = elgg_view("item_tools/forms/edit", array("folder" => $folder, "page_owner_entity" => elgg_get_page_owner_entity()));
