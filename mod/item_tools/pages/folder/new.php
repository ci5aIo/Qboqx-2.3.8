...
// get data
// build page elements
$title_text = elgg_echo("item_tools:new:title");

$form_vars = array(
	"id" => "item_tools_edit_form"
);
$body_vars = array(
...
if (elgg_is_xhr()) {
	...
	echo elgg_view_form("item_tools/folder/edit", $form_vars, $body_vars);
	echo "</div>";
} else {
	echo elgg_view_page($title_text, elgg_view_layout("one_sidebar", array(
		"title" => $title_text,
		"content" => elgg_view_form("item_tools/folder/edit", $form_vars, $body_vars)
	)));
}
