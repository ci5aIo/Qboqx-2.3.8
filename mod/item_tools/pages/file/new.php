...
$multi_vars["id"] = "item-tools-multi-form";
$multi_vars["action"] = "action/file/upload";
$zip_vars = $form_vars;
$zip_vars["id"] = "item-tools-zip-form";
$single_vars = $form_vars;
$single_vars["id"] = "item-tools-single-form";
...
$body = "<div id='item-tools-upload-wrapper'>";
$body .= elgg_view_form("file/upload", $single_vars, $body_vars);
$body .= elgg_view_form("item_tools/upload/multi", $multi_vars);
$body .= elgg_view_form("item_tools/upload/zip", $zip_vars);
$body .= "</div>";

$tabs = elgg_view("item_tools/upload_tabs", array("upload_type" => $upload_type));
