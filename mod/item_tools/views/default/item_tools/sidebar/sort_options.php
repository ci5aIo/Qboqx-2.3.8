...
$title = elgg_echo('item_tools:list:files:options:sort_title');

// sort options
$sort_value = 'e.time_created';
if (isset($_SESSION["item_tools"]) && is_array($_SESSION["item_tools"]) && !empty($_SESSION["item_tools"]["sort"])) {
	$sort_value = $_SESSION["item_tools"]["sort"];
} else {
...
if (isset($_SESSION["item_tools"]) && is_array($_SESSION["item_tools"]) && !empty($_SESSION["item_tools"]["sort_direction"])) {
	$sort_direction_value = $_SESSION["item_tools"]["sort_direction"];
} else {
...
echo elgg_view_module("aside", $title, $body, array("id" => "item_tools_list_items_sort_options"));