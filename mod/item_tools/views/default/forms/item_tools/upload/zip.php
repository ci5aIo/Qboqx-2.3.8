...
$form_body = "<div>" . elgg_echo("item_tools:upload:form:zip:info") . "</div>";

$form_body .= "<div>";
$form_body .= "<label>" . elgg_echo("item_tools:upload:form:choose") . "</label><br />";
$form_body .= elgg_view("input/file", array("name" => "zip_file"));
$form_body .= "</div>";

if (item_tools_use_folder_structure()) {
	$form_body .= "<div>";
	$form_body .= "<label>" . elgg_echo("item_tools:forms:edit:parent") . "</label><br />";
