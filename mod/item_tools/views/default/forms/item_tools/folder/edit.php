...
$form_data .= "<div>";
$form_data .= "<label>" . elgg_echo("item_tools:forms:edit:title") . "</label>";
$form_data .= elgg_view("input/text", array("name" => "title", "value" => $title));
$form_data .= "</div>";

$form_data .= "<div>";
$form_data .= "<label>" . elgg_echo("item_tools:forms:edit:description") . "</label>";
$form_data .= elgg_view("input/longtext", array("name" => "description", "value" => $desc));
$form_data .= "</div>";

$form_data .= "<div>";
$form_data .= "<label>" . elgg_echo("item_tools:forms:edit:parent") . "</label>";
$form_data .= "<br />";
$form_data .= elgg_view("input/folder_select", array("name" => "item_tools_parent_guid", "folder" => $folder, "value" => $parent, "container_guid" => $page_owner->getGUID(), 'type' => 'folder'));
$form_data .= "</div>";

// set context to influence access
$context = elgg_get_context();
elgg_set_context("item_tools");
...
if (!empty($folder)) {
	$form_data .= "<div id='item_tools_edit_form_access_extra'>";
	$form_data .= "<div>" . elgg_view("input/checkboxes", array("options" => array(elgg_echo("item_tools:forms:edit:change_children_access") => "yes"), "value" => "yes", "name" => "change_children_access")) . "</div>";
	$form_data .= "<div>" . elgg_view("input/checkboxes", array("options" => array(elgg_echo("item_tools:forms:edit:change_files_access") => "yes"), "name" => "change_files_access")) . "</div>";
	$form_data .= "</div>";
}
