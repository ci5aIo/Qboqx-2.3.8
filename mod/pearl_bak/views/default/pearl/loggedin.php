...
echo "</div>";
?>
<div class='user_menu_icons' data-messages="<?php echo $messages; ?>" data-username="<?php echo $user->username; ?>" data-url = "<?php echo $CONFIG->url; ?>" data-logout = "<?php echo $logout; ?>">
