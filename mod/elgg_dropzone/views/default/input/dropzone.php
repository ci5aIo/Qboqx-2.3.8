...
if (isset($vars['default-message'])) {
	$language['data-dict-default-message'] = $vars['default-message'];
}
...
if ($vars['compact'] == true){
	$template = elgg_view('elgg_dropzone/template_compact');
}
else {
