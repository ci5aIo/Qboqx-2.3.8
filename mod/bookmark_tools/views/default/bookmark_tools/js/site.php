...
elgg.bookmark_tools.init = function(){
	...
	$('#bookmark_tools_breadcrumbs a').on("click", elgg.bookmark_tools.breadcrumb_click);
	$('#bookmark_tools_select_all').on("click", elgg.bookmark_tools.select_all);
	$('#bookmark_tools_action_bulk_delete').on("click", elgg.bookmark_tools.bulk_delete);

	$('#bookmark_tools_list_new_folder_toggle').on('click', elgg.bookmark_tools.new_folder);
}
