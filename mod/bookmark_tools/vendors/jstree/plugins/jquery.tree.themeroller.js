		...
		"themeroller" : {
			...
			callbacks : {
				oninit : function (t) {
					...
					$("#" + this.container.attr("id") + " li a").on("mouseover", function () { $(this).addClass("ui-state-hover"); });
					$("#" + this.container.attr("id") + " li a").on("mouseout",  function () { $(this).removeClass("ui-state-hover"); });
				},
