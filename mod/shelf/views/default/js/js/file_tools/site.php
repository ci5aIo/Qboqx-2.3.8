...
elgg.file_tools.uploadify.init = function() {
	...
	if ($uploadifyButton.length) {
		$('#file-tools-uploadify-cancel').on("click", elgg.file_tools.uploadify.cancel);
...
elgg.file_tools.init = function() {
	...
	// upload functions
	$('#file-tools-upload-tabs a').on("click", elgg.file_tools.upload_tab_click);
	
	// tree functions
	elgg.file_tools.tree.init();
	
	$('#file_tools_breadcrumbs a').on("click", elgg.file_tools.breadcrumb_click);
	$('#file_tools_select_all').on("click", elgg.file_tools.select_all);
	$('#file_tools_action_bulk_delete').on("click", elgg.file_tools.bulk_delete);
	$('#file_tools_action_bulk_download').on("click", elgg.file_tools.bulk_download);
	$('#file-tools-show-more-files').on("click", elgg.file_tools.show_more_files);

	$('#file_tools_list_new_folder_toggle').on('click', elgg.file_tools.new_folder);
}
