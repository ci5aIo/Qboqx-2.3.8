...
/*
if (get_entity($container_guid)=>getSubtype() == 'market'){
    $referrer =  
...
//		system_message("market uploader");
		...
		// Create a relationship to the file, provided one exists
		if ($relationship) {
		// Create a relationship
		add_entity_relationship($file->guid, $relationship, $container_guid);
		}			
	} else {
	...
	if (elgg_instanceof($container, NULL, 'market')){
//		forward("market/view/$container_guid");
	}
