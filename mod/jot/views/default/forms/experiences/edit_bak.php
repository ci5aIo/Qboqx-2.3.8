    ...
    case 'add':
        Switch ($section){
            case 'main':
                ...
                $moment_field       = elgg_view('input/date'    , ['name' => 'jot[moment]'                                                        , 'style' => 'width:150px']);
...
*add********** $section = 'issue'                   *****************************************************************
             ****************************************/
                case 'issue':
                    unset($input_tabs, $form_body, $hidden);
                    $qid = elgg_extract('qid', $vars);
                    $hidden["jot[aspect]"] = "issue";
                    
                    $discoveries_panel = elgg_view('forms/experiences/edit', array(
                                                   'action'         => 'add',
                                                   'section'        => 'issue_discovery',//project_in_process',//observation_discoveries',
                                                   'guid'           => $guid,));
                    $resolve_panel = elgg_view('forms/experiences/edit', array(
                                                   'action'         => 'add',
...
//            		break;
                ...
                unset($form_body, $hidden, $disabled, $id_value);
                $disabled = 'disabled';
                $set_properties_button = elgg_view('output/url', array(
                           'id'    => 'properties_set',
                           'text'  => elgg_view_icon('settings-alt'), 
        	    ...
        	    <div class='rTable' style='$style'>
        			<div class='rTableBody'>
        				...
        				<div class='rTableRow'>
        					...
        					<div class='rTableCell' style='padding: 0px 0px'>$moment_field</div>
        				</div>
        			</div>
        		</div>
        		<div class='rTable'>
...
****************************************/
            case 'things':
                ...
                $form_body .= "<div panel='Things' aspect='attachments' guid=$guid id=$div_id class='elgg-head experience-panel' style='$style;'>";
					                                                      ...
					                                                      <nav class='edit'>
					                                                          <section class='controls'>
					                                                              ...
					                                                              <div class='actions'>
					                                                                ...
					                                                                <button type='button' id='story_delete_button_$cid' title='Delete this story' class='autosaves delete hoverable right_endcap remove-progress-marker' data-cid='$cid' tabindex='-1'></button>
					                                                              </div>
					                                                            </section>
					                                                      </nav>
...
****************************************/
            case 'issue':
                unset($input_tabs, $hidden_fields);
...
//                            'href'    => '#',
            	...
            	$marker_date_picker = elgg_view('input/date', ['name'  => 'jot[observation][discovery][date][]', 'style'=>'width:75px; height: 20px;']);
            	$marker_type_selector = elgg_view_field(['#type'    =>'select',
            	                                         'name'    =>'jot[observation][discovery][type][]',  
            			                                 'options_values' =>['quip'=>'Quip', 'milestone'=>'Milestone', 'check_in'=>'Check in']
            	                                         ]);
            	$marker_point_selector = elgg_view_field(['#type'=>'select',
            			                                  'name'=>'jot[observation][discovery][points][]',
            			                                   'options_values'=>[0=>'Unestimated',1=>'1 point',2=>'2 points',3=>'3 points']
            	                                        ]);
            	$marker_state_selector = elgg_view_field(['#type'   =>'select',
            			                                  'name'   =>'jot[observation][discovery][state][]',
            			                                  'options_values' =>['started'=>'Started','finished'=>'Finished','delivered'=>'Delivered','rejected'=>'Rejected','accepted'=>'Accepted']
            			                                 ]);
            	$owner                 = get_entity($owner_guid ?: elgg_get_logged_in_user_guid());
            	$marker_participant_link     = elgg_view('output/div',['class'=>'dropdown', 
					                                              ...
					                                              <section class='model_details'>
					                                                  <section class='story_or_epic_header'>
					                            					    ...
					                            					    <fieldset class='name'>
					                            					        <div data-reactroot='' class='AutosizeTextarea___2iWScFt62'>
					                            					            <div class='AutosizeTextarea__container___31scfkZp'>
					                            					               <textarea data-aid='name' tabindex='0' data-focus-id='NameEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy2 NameEdit___2W_xAa_R' name='jot[observation][discovery][title][]' placeholder='Give this discovery a name'></textarea>
					                            					            </div>
					                            					        </div>
					                            					     </fieldset>
					                            					  </section>
					                            					  <aside>
					                                                    <div class='wrapper'>
					                                                      <nav class='edit'>
					                                                          <section class='controls'>
					                                                              <div class='persistence use_click_to_copy'>
					                                                                <button class='autosaves button std close' data-cid='$cid' type='button' tabindex='-1'>Close</button>
					                                                              </div>
					                                                              <div class='actions'>
					                                                                  <div class='bubble'></div>
					                                                                ...
					                                                                <button type='button' id='story_delete_button_$cid' title='Delete this discovery' class='autosaves delete hoverable right_endcap remove-progress-marker' tabindex='-1' data-cid='$cid'></button>
					                                                              </div>
					                                                            </section>
					                                                      </nav>
					                                                      <div class='story info_box' style='display:block'><!-- hidden -->
					                                                        <div class='info'>
						                                                        <div class='date row'>
						                                                          <em>Date</em>
						                                                          <div class='dropdown story_current_state'>
						                                                            <input aria-hidden='true' type='hidden' name='jot[observation][discovery][current_state][]' value='unstarted' disabled='disabled'>
						                                                            <input aria-hidden='true' type='text' id='story_current_state_dropdown_$cid_honeypot' tabindex='-1' class='honeypot'>
						                                                            $marker_date_picker
						                                                          </div>
						                                                        </div>
					                                        	        	...
					                                        	        	<div data-aid='editor' class='textContainer___2EcYJKlD'>
					                                        	        		<div>
					                                        	        			<div class='DescriptionEdit__write___207LwO1n'>
					                                        	        				<div class='AutosizeTextarea___2iWScFt6'>
					                                        	        					<div class='AutosizeTextarea__container___31scfkZp'>
					                                        	        						<textarea name='jot[observation][discovery][action][]' aria-labelledby='description$cid' data-aid='textarea' data-focus-id='DescriptionEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy editor___1qKjhI5c tracker_markup' placeholder='Action'></textarea>
					                                        	        					</div>
					                                        	        					<div aria-hidden='true' class='AutosizeTextarea__shadowClass___34L-ruqt editor___1qKjhI5c tracker_markup'>
					                                        	        						<span></span>
					                                        	        						<span>w</span>
					                                        	        	...
					                                        	        	<div data-aid='editor' class='textContainer___2EcYJKlD'>
					                                        	        		<div>
					                                        	        			<div class='DescriptionEdit__write___207LwO1n'>
					                                        	        				<div class='AutosizeTextarea___2iWScFt6'>
					                                        	        					<div class='AutosizeTextarea__container___31scfkZp'>
					                                        	        						<textarea name='jot[observation][discovery][observation][]' aria-labelledby='observation$cid' data-aid='textarea' data-focus-id='ObservationEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy editor___1qKjhI5c tracker_markup' placeholder='Observations'></textarea>
					                                        	        					</div>
					                                        	        					<div aria-hidden='true' class='AutosizeTextarea__shadowClass___34L-ruqt editor___1qKjhI5c tracker_markup'>
					                                        	        						<span></span>
					                                        	        						<span>w</span>
					                                        	        	...
					                                        	        	<div data-aid='editor' class='textContainer___2EcYJKlD'>
					                                        	        		<div>
					                                        	        			<div class='DescriptionEdit__write___207LwO1n'>
					                                        	        				<div class='AutosizeTextarea___2iWScFt6'>
					                                        	        					<div class='AutosizeTextarea__container___31scfkZp'>
					                                        	        						<textarea name='jot[observation][discovery][discovery][]' aria-labelledby='discovery$cid' data-aid='textarea' data-focus-id='DiscoveryEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy editor___1qKjhI5c tracker_markup' placeholder='Conclusions'></textarea>
					                                        	        					</div>
					                                        	        					<div aria-hidden='true' class='AutosizeTextarea__shadowClass___34L-ruqt editor___1qKjhI5c tracker_markup'>
					                                        	        						<span></span>
					                                        	        						<span>w</span>
	...
	/*                $preview = "
	            	...
	            	$quick_input = elgg_view('input/text', array('name'=>'jot[observation][discovery][title][]', 'data-aid'=>'name', 'data-focus-id'=>'NameEdit--c1037'));
	            	$edit_details = elgg_view('output/section', array('content'=>$expander, 'class'=>'edit details', 'options'=>['style'=>'display:none']));
	            	$view_id      = 'view274';
	            	$data_id      = '147996415';
	            	$edit_details = elgg_view('output/div',['class'=>'story model item draggable feature unscheduled point_scale_linear estimate_-1 is_estimatable',
...
****************************************/
            case 'issue_resolve':
            	...
            	$view_id = '<<view_id>>';
            	$url = elgg_get_site_url().'jot';
            	$marker_date_picker = elgg_view('input/date', ['name'  => 'jot[observation][effort][date][]', 'style'=>'width:75px; height: 20px;']);
            	$marker_type_selector = elgg_view_field(['#type'    =>'select',
            	                                         'name'    =>'jot[observation][effort][type][]',  
            			                                 'options_values' =>['investigation'=>'Investigation', 'repair'=>'Repair', 'test'=>'Test']
            	                                         ]);
            	$marker_point_selector = elgg_view_field(['#type'=>'select',
            			                                  'name'=>'jot[observation][effort][points][]',
            			                                   'options_values'=>[0=>'Unestimated',1=>'1 point',2=>'2 points',3=>'3 points']
            	                                        ]);
            	$marker_state_selector = elgg_view_field(['#type'   =>'select',
            			                                  'name'   =>'jot[observation][effort][state][]',
            			                                  'options_values' =>['started'=>'Started','finished'=>'Finished','delivered'=>'Delivered','rejected'=>'Rejected','accepted'=>'Accepted']
            			                                 ]);
            	$owner                 = get_entity($owner_guid ?: elgg_get_logged_in_user_guid());
            	$marker_work_order_no  = elgg_view_field(['#type'   => 'text',
            			                                  'name'    => 'jot[observation][effort][wo_no][]']);
            	$marker_participant_link     = elgg_view('output/div',['class'=>'dropdown', 
            			                                         'content' =>elgg_view('output/url',['class'=>'selection',
						            			                                 'href' => "profile/{$owner->username}",
						            			                                 'text' => elgg_view('output/span',['content'=>elgg_view('output/div',['class'=>'name', 'options'=>['style'=>'float:right'], 'content'=>$owner->name,]).
            	...
            	switch($snippet){
            		case 'marker':
            			$form_body .= elgg_view('output/div',['content'=>"<div id='$view_id' class='edit details issue_resolve-marker' data-cid=$cid data-guid=$guid data-qid=$qid>
					    					                   <section class='edit' data-aid='StoryDetailsEdit' style='width: 420px;' tabindex='-1'>
					                                              <section class='model_details'>
					                                                  <section class='story_or_epic_header'>
					                                                    <a class='autosaves collapser' id='story_collapser_$cid' data-cid='$cid' tabindex='-1'></a>
					                            					    <fieldset class='name'>
					                            					        <div data-reactroot='' class='AutosizeTextarea___2iWScFt62' style='display:flex'>
					                            					            <div class='AutosizeTextarea__container___31scfkZp' style='flex-basis: 300px; order:1'>
					                            					               <textarea data-aid='name' tabindex='0' data-focus-id='NameEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy2 NameEdit___2W_xAa_R' style='margin: 8px;' name='jot[observation][effort][title][]' placeholder='Give this effort a name'></textarea>
					                            					            </div>
					                                                            <div class='persistence use_click_to_copy' style='order:1'>
					                                                               <button class='autosaves button std close' type='button' tabindex='-1' style='margin: 3px 3px 0 15px;' data-cid='$cid'>Close</button>
					                                                            </div>
					                            					        </div>
					                            					     </fieldset>
					                            					  </section>
					                                                    ...
					                                                    <div class='wrapper'>
					                                                      <nav class='edit'>
					                                                          <section class='controls'>
					                                                              <div class='actions'>
					                                                                  <div class='bubble'></div>
					                                                                  <button type='button' id='story_copy_link_$cid' title='Copy this effort&#39;s link to your clipboard' data-clipboard-text='$url/view/$id_value' class='autosaves clipboard_button hoverable link left_endcap' tabindex='-1' $disabled></button>
					                                                                  <div class='button_with_field'>
						                                                                  <button type='button' id ='story_copy_id_$cid' title='Copy this effort&#39;s ID to your clipboard' data-clipboard-text='$id_value' class='autosaves clipboard_button hoverable id use_click_to_copy' tabindex='-1' $disabled></button>
						                                                                  <input type='text' id='story_copy_id_value_$cid' readonly='' class='autosaves id text_value' value='$id_value' tabindex='-1'>
					                                                                </div>
					                                                                <button type='button' id='receipt_import_button_$cid' title='Import receipt' class='autosaves import_receipt hoverable left_endcap' tabindex='-1'></button>
					                                                                <button type='button' id='story_clone_button_$cid' title='Clone this effort' class='autosaves clone_story hoverable left_endcap' tabindex='-1' $disabled></button>
					                                                                <button type='button' id='story_history_button_$cid' title='View the history of this effort' class='autosaves history hoverable capped' tabindex='-1' $disabled></button>
					                                                                <button type='button' id='story_delete_button_$cid' title='Delete this effort' class='autosaves delete hoverable right_endcap remove-progress-marker' tabindex='-1'></button>
					                                                              </div>
					                                                            </section>
					                                                      </nav>
					                                                      <div class='story info_box' style='display:block'><!-- hidden -->
					                                                        <div class='info'>
					                                                            <div class='type row'>
					                                                              <em>Effort Type</em>
					                                                              <div class='dropdown story_type'>
					                                                                  <input aria-hidden='true' type='hidden' name='jot[observation][effort][type][]' value='feature'>
					                                                                  <input aria-hidden='true' type='text' id='story_type_dropdown_$cid_honeypot' tabindex='0' class='honeypot'>
					                                                                  $marker_type_selector
						                                                            </div>
						                                                        </div>
						                                                        <div class='date row'>
						                                                          <em>Date</em>
						                                                          <div class='dropdown story_current_state'>
						                                                            <input aria-hidden='true' type='hidden' name='jot[observation][effort][current_state][]' value='unstarted' disabled='disabled'>
						                                                            <input aria-hidden='true' type='text' id='story_current_state_dropdown_$cid_honeypot' tabindex='-1' class='honeypot'>
						                                                            $marker_date_picker
						                                                          </div>
						                                                        </div>
						                                                       <div class='state row'>
						                                                          <em>State</em>
						                                                          <div class='dropdown story_current_state disabled'>
						                                                            <input aria-hidden='true' type='hidden' name='jot[observation][effort][current_state][]' value='started' disabled='disabled'>
						                                                            <input aria-hidden='true' type='text' id='story_current_state_dropdown_$cid_honeypot' tabindex='-1' class='honeypot'>
						                                                            $marker_state_selector
						                                                        </div>
						                                                    </div>
					                                                        <div class='requester row'>
					                                                          <em>Organization</em>
					                                                          <div class='dropdown story_scribe_id'>
					                                                            <input aria-hidden='true' type='hidden' name='jot[observation][effort][org_id][]' data-type='number'>
					                                                            <input aria-hidden='true' type='text' id='story_scribe_id_dropdown_$cid_honeypot' tabindex='0' class='honeypot'>
					                                                            <a id='effort_org_id_dropdown_$cid' class='selection item_2936271' tabindex='-1'><span><div class='name'>??</div></span></a>
					                                                          <section>
					                                                            <div class='dropdown_menu search'>
					                                                                  <div class='search_item'><input aria-label='search' type='text' id='effort_org_id_dropdown_$cid_search' class='search'></div>
					                                                              <ul>
					                                                                  <li class='no_search_results hidden'>No results match.</li>
					                                        	...
					                                        	<section class='description full'>
					                                        	    <div data-reactroot='' data-aid='Description' class='Description___3oUx83yQ issue_resolve-marker'>
					                                        	        $service_panel
					                                        	    </div>
					                                        	</section>
					                                        	<section class='media full'>
	                ...
	                if (!empty($hidden)){                
	                    foreach($hidden as $field=>$value){
	                        $hidden_fields .= elgg_view('input/hidden', array('name'=>$field, 'value'=>$value));}}
	                $add_effort_button = elgg_view('output/url', array(
	                                        'title'    => 'Add effort',
	                		                'data-element' => 'new_effort',
	                    					'class'    => 'trigger-element add_marker',
	                                        'tabindex' => '-1',
	                						'data-guid'=> $guid,
	                						'data-qid' => $qid,
	            	...
	            	$panel_header   = elgg_view('output/header', ['class'=>'tn-PanelHeader___c0XQCVI7 tn-PanelHeader--single___2ns28dRL pin',
            	                                                  ...
            	                                                  'content' => elgg_view('output/div',['class'=>'tn-PanelHeader__inner___3Nt0t86w tn-PanelHeader__inner--single___3Nq8VXGB',
            	                                                  		                               'options'=>['data-aid'=>'highlight',
            	                                                   		                               ...
            	                                                   		                               'content'=> elgg_view('output/div',['class'=>'tn-PanelHeader__actionsArea___EHMT4f1g undraggable',
            	                                                   		                               									   'content'=> elgg_view('output/div',['class'=>'tn-PanelHeader__action___3zvuQp6Z',
            	                                                   		                                		                            		                           'content'=>$add_effort_button])])
            	                                                   		                                         . elgg_view('output/div',['class'=>'tn-PanelHeader__titleArea___1DRH-oDF',
            	                                                   		                                            		               'content'=> elgg_view('output/div',['class'=>'tn-PanelHeader__name___2UfJ8ho9',
            	                                                   		                                            		                  		                           'options'=>['data-aid'=>'PanelHeader__name'],
            	                                                   		                                            		                  		                           'content'=>'Efforts to resolve'])])
            	                                                   		                                         . elgg_view('output/div',['class'=>'tn-PanelHeader__actionsArea___EHMT4f1g undraggable',
            	                                                   		                                            		               'content'=> "<a class='' data-aid='DropdownButton'>
																                                                                            				<div title='Panel actions' class='tn-DropdownButton___nNklb3UY'></div>
																                                                                            			</a>"])])]);
	...
	/*                $preview = "
	            	...
	            	$quick_input = elgg_view('input/text', array('name'=>'jot[observation][effort][title][]', 'data-aid'=>'name', 'data-focus-id'=>'NameEdit--c1037'));
	            	$edit_details = elgg_view('output/section', array('content'=>$expander, 'class'=>'edit details', 'options'=>['style'=>'display:none']));
	            	$view_id      = 'view274';
	            	$data_id      = '147996415';
	            	$edit_details = elgg_view('output/div',['class'=>'story model item draggable feature unscheduled point_scale_linear estimate_-1 is_estimatable',
                    			    		                'options'=>['data-cid'=>$cid,'data-id'=>$data_id],
                    			    		                'content'=>$view_summary
                    			    		                         . elgg_view('forms/experiences/edit',['section'=>'project_in_process', 'snippet'=>'marker', 'cid'=>$cid, 'qid'=>$qid])]);
	            	$story_model .= elgg_view('output/div', ['class'  =>'rTableRow story',
	                                                        'content'=>elgg_view('output/div', ['class'  =>'rTableCell',
	                                                                                            'options'=>['style'=>'width:100%; padding: 0px 0px;vertical-align:top'],
	                                                                                            'content'=>elgg_view('output/div',  ['class'  =>'story model item pin',
...
****************************************/
            case 'issue_effort_service':
            	...
            	$add_story_button = elgg_view('output/url', array(
						...
						$add_task = elgg_view('forms/experiences/edit',['section'=>'issue_effort_service', 'action'=>'add', 'snippet'=>'service_item', 'cid'=>$cid, 'qid'=>$qid_n, 'guid'=>$guid]);
						//$add_properties = ;
		                $line_items_header= "          
				...
				Switch ($snippet){
					case 'marker':
            			$form_body .= elgg_view('output/div',['content'=>"<div id='$view_id' class='edit details issue_effort_service-marker' data-cid=$cid>
					    					                   <section class='edit' data-aid='StoryDetailsEdit' tabindex='-1' style='display: inline-grid;'>
					                                              <section class='model_details'>
					                                                  <section class='story_or_epic_header'>
					                                                    <a class='autosaves collapser' id='story_collapser_$cid' data-cid='$cid' tabindex='-1'></a>
					                            					    <fieldset class='name'>
					                            					        <div data-reactroot='' class='AutosizeTextarea___2iWScFt62' style='display:flex'>
					                            					            <div class='AutosizeTextarea__container___31scfkZp' style='flex-basis: 300px;'>
					                            					               <textarea data-aid='name' tabindex='0' data-focus-id='NameEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy2 NameEdit___2W_xAa_R' name='jot[observation][effort][title][]' placeholder='Give this effort a name'></textarea>
					                                                              <div class='persistence use_click_to_copy'>
					                                                                <button class='autosaves button std close' type='button' tabindex='-1'>Close</button>
					                                                              </div>
					                            					            </div>
					                                        	...
					                                        	<section class='description full issue_effort_service-marker'>
					                                        	    <div data-reactroot='' data-aid='Description' class='Description___3oUx83yQ'><h4>What I did ...</h4>
					                                        	        <div data-focus-id='DescriptionShow--$cid' data-aid='renderedDescription' tabindex='0' class='DescriptionShow___3-QsNMNj tracker_markup DescriptionShow__placeholder___1NuiicbF'>Action
					                                        	        </div>
					                                        	        <div class='DescriptionEdit___1FO6wKeX' style='display:none'>
					                                        	        	<div data-aid='editor' class='textContainer___2EcYJKlD'>
					                                        	        		<div>
					                                        	        			<div class='DescriptionEdit__write___207LwO1n'>
					                                        	        				<div class='AutosizeTextarea___2iWScFt6'>
					                                        	        					<div class='AutosizeTextarea__container___31scfkZp'>
					                                        	        						<textarea name='jot[observation][effort][action][]' aria-labelledby='description$cid' data-aid='textarea' data-focus-id='DescriptionEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy editor___1qKjhI5c tracker_markup' placeholder='Action'></textarea>
					                                        	        					</div>
					                                        	        					<div aria-hidden='true' class='AutosizeTextarea__shadowClass___34L-ruqt editor___1qKjhI5c tracker_markup'>
					                                        	        						<span></span>
					                                        	        						<span>w</span>
						...
						break;
					case 'marker1':
						$form_body.="<div class='ServiceEffort__26XCaBQk issue_effort_service-marker1' data-cid=$cid>
							<div tabindex='0' class='AddSubresourceButton___2PetQjcb' data-aid='TaskAdd' data-focus-id='TaskAdd' data-cid=$cid>
			                            ...
			                            <fieldset class='name'>
			                            	<div class='AutosizeTextarea___2iWScFt6' style='display: flex;'>
												<div data-reactroot='' class='AutosizeTextarea___2iWScFt62' style='flex-basis: 300px;'>
	                            					<div class='AutosizeTextarea__container___31scfkZp'>
	                            					    <textarea data-aid='name' tabindex='0' data-focus-id='NameEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy2 NameEdit___Makc44_0' style='padding-top: 0px;margin: 8px;' name='jot[observation][effort][title][]' placeholder='Service name'></textarea>
	                            					</div>
	                            				</div>
												<button data-aid='addTaskButton'  type='submit'  class='TaskEdit__submit___3m10BkLZ std' style='margin: 3px 3px 0 15px;' data-cid='$cid' data-qid='$qid'>Add
												</button>
	                            			</div>
	                            		</fieldset>
		                                <section class='description full'>
		                                        	    ...
		                                        	    <div data-aid='editor' class='textContainer___2EcYJKlD'>
		                                        	        <div>
		                                        	        	<div class='ServiceEdit__write___207LwO1n'>
		                                        	        		<div class='AutosizeTextarea___2iWScFt6'>
		                                        	        			<div class='AutosizeTextarea__container___31scfkZp'>
		                                        	        				<textarea name='jot[observation][discovery][discovery][]' aria-labelledby='discovery$cid' data-aid='textarea' data-focus-id='ServiceEdit--$cid' class='AutosizeTextarea__textarea___1LL2IPEy editor___1qKjhI5c tracker_markup' style='margin: 0px 0px 3px;display: block;' placeholder='Describe the service'></textarea>
		                                        	        			</div>
			                                        	        		<div aria-hidden='true' class='AutosizeTextarea__shadowClass___34L-ruqt editor___1qKjhI5c tracker_markup'>
				                                        	        		<span></span>
				                                        	        		<span>w</span>
					...
					case 'service_item':
						...
						$form_body .="
								<div class='rTableRow $element ui-sortable-handle TaskEdit___1Xmiy6lz' style='display:none' data-cid=$cid>
				                ...
				                <div class='ServiceEffort__26XCaBQk issue_effort_service-service_item' data-cid=$cid>
									<div tabindex='0' class='AddSubresourceButton___2PetQjcb' data-aid='TaskAdd' data-focus-id='TaskAdd' data-cid=$cid>
										 <span class='AddSubresourceButton__icon___h1-Z9ENT'></span>
					...
					default:
						...
						$add_task = elgg_view($form,['section'=>'issue_effort_service', 'action'=>'add', 'snippet'=>'service_item', 'cid'=>$cid, 'qid'=>$qid_n, 'guid'=>$guid]);
						$form_body .= "<div data-aid='Tasks' class='issue_effort_service-default'>
							<span class='tasks_count' data-aid='taskCounts'><h4>What I did ...</h4>
							</span>
							$add_task
						</div>";                                                                      				$display .= 'issue_effort_service-default ... <br>$cid: '.$cid.'<br>$service_cid: '.$service_cid;
	                break;
				}
