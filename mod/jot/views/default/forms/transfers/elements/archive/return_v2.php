...
if (isset($merchants)) {
    if (elgg_entity_exists($merchants[0]->guid)){
    	$merchant = elgg_view('output/url', array('text' => $merchants[0]->name,'href' =>  "groups/profile/$merchants[0]->guid"));
	}
}
elseif (elgg_instanceof(get_entity($merchant), 'group')){                                                       $display .= '242 $merchant: '.$merchant.'<br>';
    $merchant = elgg_view('output/url', array('text' => get_entity($merchant)->name,'href' =>  "groups/profile/$entity->merchant"));}
...
foreach($hidden_fields as $name => $value){
	...
	$title_input    = elgg_view('input/text'  , array('name' => 'jot[title]'                  , 'value' => "[Return] $title",));
    ...
    $return_date    = elgg_view('input/date'  , array('name' => 'jot[return_date]'            , 'value' => $entity->return_date,));
    $return_date   .= elgg_view('input/hidden', array('name' => 'jot[snapshot][return_date]'  , 'value' => $entity->return_date,));
	...
	$form .= "<div class='rTable' style='width:600px'>
			<div class='rTableBody'>
				<div class='rTableRow'>
					...
					<div class='rTableCell' style='width:510px'>[Ret]$title_input
					</div>
				</div>
				<div class='rTableRow'>
	...
	$form .= "<div class='rTable' style='width:700px'>
			<div class='rTableBody'>
				<div class='rTableRow'>
					...
					<div class='rTableCell' style='width:100px'>Purchase Date</div>
