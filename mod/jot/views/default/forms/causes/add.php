Form: jot\views\default\forms\observations\add.php<br>
<?php
...
$ts = time();
$title = elgg_echo("New Observation");
$tags = "";
//echo elgg_dump($item);
...
echo '<p><label>Describe your observation</label>';
if ($allowhtml != 'yes') {
...
echo "<p>";
echo elgg_view('input/submit', array('name' => 'submit', 'value' => elgg_echo('jot:save:observation')));
