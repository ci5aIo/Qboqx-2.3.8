...
$perspective   = elgg_extract('perspective',  $vars, $action);
...
//register_error($display);
    ...
    case 'edit':
        Switch ($view_type){
            ...
            case 'popup':
                ...
                $body  = elgg_view_form('transfers/edit',['action'=>$form_action, 'id'=> "{$perspective}_{$space}"],$params);
                break;
            default:
    ...
    default:
        ...
        /*        elgg_load_library('elgg:market');
            ...
            case 'compact dropdown':
            case 'popup':
                $body = elgg_view('jot/display/transfer/summary', $params);
            	break;
            default:
            	$list_body = elgg_view('object/elements/summary', $params);
            	$extra_params = $vars;
