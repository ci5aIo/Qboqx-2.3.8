...
$fields       = insight_prepare_brief_view_vars($insight, $section);
echo "<!--Section = $section-->";
/**/
$documents = elgg_get_entities_from_relationship(array(
	'type' => 'object',
	'relationship' => 'document',
	'relationship_guid' => $insight->guid,
...
$issues = elgg_get_entities_from_relationship(array(
	...
	echo '<table><tr><td width=100%><b>Documentation</b></td>
		      ...
		      elgg_view('output/url', array(
                ...
                'href' => "jot/attach?element_type=document&container_guid=" . $insight->guid)).'</td>';
	echo '</tr>
	      <tr><td colspan=2>';
	...
	echo '<tr><td><b>Issues</b></td>
	      ...
	      elgg_view('output/url', array(
			'text' => '[add new issue]', 
			'href' => "jot/add/$insight_guid/issue")).'</td>';
	echo '</tr>
	      <tr><td colspan=2>';
		if ($issues) {
		foreach ($issues as $i) {
	...
	echo '<tr><td><b>Tasks</b></td>
	      ...
	      elgg_view('output/url', array(
			'text' => '[add new task]', 
			'href' => "tasks/add/".$entity->owner_guid."?element_type=task&container_guid=".$insight->guid
	      )).'
	      </td></tr>';
