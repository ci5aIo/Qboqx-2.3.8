<!-- /mod/jot/views/default/jot/display/transfer/details.php -->
<?php
/*
 * Transfer Details
*/ 
...
// Input form
			$form_action = "action/transfers/edit";
		...
		if ($entity->state <= 3){
		    ...
		    $form_body .=   $entity->transfer_date;
            $form_body .=   elgg_view("input/hidden", array(
								        "name" => "transfer_date",
										"value" => $entity->transfer_date,
										'class' => 'tiny date',
...
if($entity->state <= 3){
	$add_discovery = elgg_view_form('jot/add/element', array("action" => "action/jot/add/element?element_type=transfer&guid=$item_guid&asset=$asset"));
...
// discoveries
	echo '<tr>
	        <td colspan=2><b>Discoveries</b>&nbsp;
		        <span class="hoverhelp">[?]
		        <span style="width:500px;"><p>Discoveries are a series of transfers made to understand an issue.  Each transfer can have further discoveries.  All transfers roll up to the containing transfer.</p><p>Enter your transfer and click [add] to add a new transfer.</span>
		        </span>
	        </td>
	      </tr>
	      <tr>
