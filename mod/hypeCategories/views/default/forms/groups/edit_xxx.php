            ...
            <?php
                ...
                if (!isset($vars['entity'])) {
                    ...
                    if (elgg_get_plugin_setting('allow_groups', 'hypeCategories') == 'yes') {
                        echo elgg_view('hypeCategories/forms/assign', array('current_category' => $current_category, 'groupedit' => 'groupedit'));
                        echo '<br>';
                    }
                } else {
                    echo elgg_echo('hypeCategories:group:current') . get_entity(get_item_categories($vars['entity']->guid))->title . '<br>';
                    echo elgg_echo('hypeCategories:group:assigned');
                }
            ?>        </p>
            <p>
                <label>
...
<?php echo elgg_view('input/access', array('internalname' => 'membership', 'value' => $membership, 'options' => array(ACCESS_PRIVATE => elgg_echo('groups:access:private'), ACCESS_PUBLIC => elgg_echo('groups:access:public')))); ?>
        ...
        ?>
            ...
            ?>
                <input type="hidden" name="user_guid" value="<?php echo elgg_get_page_owner_entity()->guid; ?>" />
                <input type="submit" class="submit_button" value="<?php echo elgg_echo("save"); ?>" />
