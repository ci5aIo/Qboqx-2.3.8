...
<?php
            ...
            if (in_array('album', string_to_tag_array(elgg_get_plugin_setting('allowed_object_types', 'hypeCategories')))) {
...
?><p>
            ...
            ?>
                <p>
            <?php
                    echo elgg_view('input/checkboxes', array('internalname' => "cover",
