<?php
	...
	// INSERT EXTRAS HERE
        ...
        // hypeCategories CATEGORIES INPUT
                ...
                if (in_array('blog', string_to_tag_array(elgg_get_plugin_setting('allowed_object_types', 'hypeCategories')))) {
                    $categories_input = elgg_view('hypeCategories/forms/assign', array('current_category' => $current_category));
                }
