...
<table class="task" style="color: #aaa; width: 100%; font-size: 85%">
	<tr>
		<td width="55%">
		<?php echo elgg_echo('tasks:percent_done'). " : " .elgg_view('output/text',array('value' => 0+$entity->percent_done."%")); ?>
		</td>
		<td width="45%">
		<?php echo elgg_echo('tasks:work_remaining'). " : " .elgg_view('output/text',array('value' => 100-$entity->percent_done."%")); ?>
		</td>
	</tr>
	<tr>
		<td width="55%">
