...
/*
if (substr($owner->name, (strlen($owner->name)-1)) === 's'){
	$title = elgg_echo('tasks:owner:apostrophy', array($owner->name));
}
else {
	$title = elgg_echo('tasks:owner:apostrophy-s', array($owner->name));
}*/
